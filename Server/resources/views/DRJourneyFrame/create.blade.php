...
@section('main')
    <div id="formContanier" class="container mt-5 pb-5">
        ...
        <fieldset class="active mb-5">
            ...
            <div class="mb-3">
                <label class="custom_label mb-3" for="name">
                    <img class="me-2" src="{{ asset('public/images/icon_logo.png') }}" width="21">
                    Doctor Name <span class="text-danger">* (Please verify doctor’s spelling)</span>
                </label>
            ...
            <div class="mb-3">
                <label class="custom_label mb-3" for="uid_no">
                    <img class="me-2" src="{{ asset('public/images/icon_logo.png') }}" width="21">
                    UID No <span class="text-danger">*</span>
                </label>
                <input id="uid_no" name="uid_no" class="form-control custom_field" type="text"
                    value="{{ isset($data) ? $data?->uid_no : '' }}" placeholder="Enter UID No" maxlength="25" required>
            </div>
            ...
            <div class="row">
                <div class="mb-3 col-md-6">
                    <label class="custom_label mb-3" for="city_collage_name">
                        <img class="me-2" src="{{ asset('public/images/icon_logo.png') }}" width="21">
                        City of MBBS College<span class="text-danger">*</span>
                    </label>
                    <input id="city_collage_name" name="city_collage_name" class="form-control custom_field"
                        type="text" value="{{ isset($data) ? $data?->city_collage_name : '' }}"
                        placeholder="e.g.. K J Somaiya Medical College" maxlength="25">
                </div>

                <div class="mb-3 col-md-6">
                    <label class="custom_label mb-3" for="city_pg_name">
                        <img class="me-2" src="{{ asset('public/images/icon_logo.png') }}" width="21">
                        City of PG Institute<span class="text-danger">*</span>
                    </label>
                    <input id="city_pg_name" name="city_pg_name" class="form-control custom_field" type="text"
                        value="{{ isset($data) ? $data?->city_pg_name : '' }}"
                        placeholder="e.g.. K J Somaiya Medical College" maxlength="25" required>
                </div>
            ...
            <div class="mb-3">
                <label class="custom_label mb-3">
                    <img class="me-2" src="{{ asset('public/images/icon_logo.png') }}" width="21">
                    Area of Expertise <span class="text-danger">* (You can select multiple areas of expertise)</span>
                </label>
        ...
        <fieldset>
            ...
            <div class="radio-group square-radio mx-3 my-3">
                <label class="square-radio-option">
                    ...
                    <span class="square-box"><i class="fa-solid fa-check"></i></span>
                    <span id="square-label" class="square-label">I agree with this terms</span>
                </label>
            </div>
        ...
        <fieldset>
            ...
            <div class="mb-3">
                ...
                <div class="text-danger text-small mb-2">
                    (Please add doctor image above 1 MB and upload doctor image with clear background)
                </div>
        ...
        <fieldset>
            <h3 class="fw-medium title_section mb-5 text-center">Upload Doctor Visiting Card/ Prescription Pad/ Letter Head
            </h3>
            <!-- Hidden Inputs -->
            ...
            <div class="mb-3">
                ...
                <!-- File Input -->
                <input id="photoInputFront" class="form-control custom_field" type="file">
            ...
            <div class="mb-3">
                ...
                <!-- File Input -->
                <input id="photoInputBack" class="form-control custom_field" type="file">
            ...
            <div id="cardPreviewSection" class="row justify-content-center mt-4 d-none">
                ...
                <!-- Front Image -->
                <div class="col-md-4 text-center card-front-preview d-none">
                    <img id="preview_front" class="img-fluid preview-img" src="">
                    <h5 class="my-2">Front Image</h5>
                </div>

                <!-- Back Image -->
                <div class="col-md-4 text-center card-back-preview d-none">
                    <img id="preview_back" class="img-fluid preview-img" src="">
                    <h5 class="my-2">Back Image</h5>
                </div>
...
@push('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            let cardFrontPng = '';
            let cardBackPng = '';
            $('#photoInputFront').on('change', function(e) {

                let files = e.target.files;

                $('#cardPreviewSection').removeClass('d-none');
                $('.card-front-preview').removeClass('d-none');
                if (files[0]) {
                    $('#card_f_photo').val('');
            ...
            $('#photoInputBack').on('change', function(e) {

                let files = e.target.files;
                $('#cardPreviewSection').removeClass('d-none');
                $('.card-back-preview').removeClass('d-none');
                if (files[0]) {
                    $('#card_b_photo').val('');
            ...
            // $("#city_collage_name").val("Ontario");
            // $("#city_pg_name").val("Ontario");
            ...
            // let requestCount = @json($requestCount ?? null);
            ...
            $(".next").on("click", async function() {
                ...
                if (step === 1) {
                    ...
                    let uid_no = $("#uid_no").val().trim();
                    let dr_specialty = $("#dr_specialty").val().trim();
                    let collage = $("#collage_name").val().trim();
                    let pg = $("#pg_name").val().trim();
                    let city_collage = $("#city_collage_name").val().trim();
                    let city_pg = $("#city_pg_name").val().trim();
                    ...
                    if (!uid_no) {
                        $("#uid_no").focus();
                        return Swal.fire("Required", "Please Enter Doctor UID No", "warning");
                    }
                    ...
                    if (!city_collage) {
                        $("#city_collage_name").focus();
                        return Swal.fire("Required", "Please Enter City of MBBS College", "warning");
                    }

                    if (!city_pg) {
                        $("#city_pg_name").focus();
                        return Swal.fire("Required", "Please Enter City of PG Institute", "warning");
                    }
                ...
                if (step === 4) {
                    // let inputFront = $('#photoInputFront')[0];
                    // let inputBack = $('#photoInputBack')[0];
                    // let fileFront = inputFront.files;
                    // let fileBack = inputBack.files;
                ...
                if (step === 5) {
                    ...
                    fd.append("city_collage_name", $("#city_collage_name").val().trim());
                    fd.append("city_pg_name", $("#city_pg_name").val().trim());
