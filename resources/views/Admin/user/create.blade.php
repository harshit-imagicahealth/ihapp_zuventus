                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="parent_employee_code" name="parent_employee_code"
                            value="{{ old('parent_employee_code') }}" placeholder="Enter parent employee code">
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row g-3 mt-2">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" id="employee_pos_code" name="employee_pos_code">
                            ...
                            <option value="ME" {{ old('employee_pos_code') == 'ME' ? 'selected' : '' }}>ME</option>
                            <option value="ASM" {{ old('employee_pos_code') == 'ASM' ? 'selected' : '' }}>ASM</option>
                            <option value="RSM" {{ old('employee_pos_code') == 'RSM' ? 'selected' : '' }}>RSM</option>
                            <option value="ZSM" {{ old('employee_pos_code') == 'ZSM' ? 'selected' : '' }}>ZSM</option>
                            <option value="GM" {{ old('employee_pos_code') == 'GM' ? 'selected' : '' }}>GM</option>
                        </select>
                    </div>
                    <div class="col-md-6">
                        <div class="mt-3">
                ...
                <div class="row g-3 mt-2">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="hq" name="hq"
                            value="{{ old('hq') }}" placeholder="Enter HQ">
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="zone" name="zone"
                            value="{{ old('zone') }}" placeholder="Enter zone">
                    </div>
                </div>
            <div class="row g-2 mt-2">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="unique_id" name="unique_id"
                        value="{{ old('unique_id') }}" placeholder="Enter unique ID">
                </div>
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="target_enrollment" name="target_enrollment"
                        value="{{ old('target_enrollment') }}" placeholder="Enter target enrollment">
                </div>
            </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                const requiredFields = ['employee_code', 'employee_pos_code', 'designation', 'name', 'mobile_no', 'emailid', 'unique_id'
                ];
                let errors = [];
